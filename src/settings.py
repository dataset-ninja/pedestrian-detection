...
PROJECT_NAME_FULL: str = "Pedestrian Detection"
...
HOMEPAGE_URL: str = "https://www.kaggle.com/datasets/karthika95/pedestrian-detection"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 7096674
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/pedestrian-detection"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = ["https://www.kaggle.com/datasets/karthika95/pedestrian-detection"]
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://link.springer.com/chapter/10.1007/978-981-15-7031-5_103"]
